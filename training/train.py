...
if __name__ == "__main__":
    ...
    parser.add_argument(
        ...
        type=str,
        default=None,
        help="Weights & Biases project name (enables W&B when set). Also set WANDB_API_KEY or run `wandb login`.",
    )
    parser.add_argument(
        "--wandb-name",
        type=str,
        default=None,
        help="Weights & Biases run name (optional). Default: auto-generated by W&B.",
    )
    parser.add_argument(
        "--wandb-entity",
        type=str,
    ...
    if (
        ...
        or args.wandb_name is not None
